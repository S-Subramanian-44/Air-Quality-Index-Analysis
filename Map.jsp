...
out.println("         </nav>");
out.println("      </div>");
out.println("   <div id=\"jspContent\">");
out.println("   </div>");
out.println("<div class=\"chart-container\">");
out.println("    <div class=\"chart\" id=\"no2_chart\">");
out.println("        <iframe src=\"no2_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"o3_chart\">");
out.println("        <iframe src=\"o3_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"so2_chart\">");
out.println("        <iframe src=\"so2_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"pm2_5_chart\">");
out.println("        <iframe src=\"pm2_5_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"pm10_chart\">");
out.println("        <iframe src=\"pm10_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"nh3_chart\">");
out.println("        <iframe src=\"nh3_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"Parti_matt_chart\">");
out.println("        <iframe src=\"Parti_matt_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"no_chart\">");
out.println("        <iframe src=\"no_chart.html\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("</div>");
out.println("");
out.println("   </div>");
...
// jQuery script to load the content
out.println("   <script>");
out.println("      $(document).ready(function () {");
out.println("         // Load the content of scatter_map_plot_hover_details.jsp into the #jspContent div");
out.println("         $(\"#jspContent\").load(\"scatter_map_plot_hover_details.jsp\");");
out.println("      });");
out.println("   </script>");
