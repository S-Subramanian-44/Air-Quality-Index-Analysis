...
out.println("        <iframe src=\"Coimbatore_1.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"o3_chart\">");
out.println("        <iframe src=\"Coimbatore_2.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"so2_chart\">");
out.println("        <iframe src=\"Coimbatore_3.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"pm2_5_chart\">");
out.println("        <iframe src=\"Coimbatore_4.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"pm10_chart\">");
out.println("        <iframe src=\"Coimbatore_5.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"nh3_chart\">");
out.println("        <iframe src=\"Coimbatore_6.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"Parti_matt_chart\">");
out.println("        <iframe src=\"Coimbatore_7.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("");
out.println("    <div class=\"chart\" id=\"no_chart\">");
out.println("        <iframe src=\"Coimbatore_8.jsp\" width=\"100%\" height=\"500px\"></iframe>");
out.println("    </div>");
out.println("</div>");
out.println("");
out.println("   </div>");
